#!/usr/bin/env python3
"""
Train TRUE RQE-PPO on Cliff Walk Environment

This tests the corrected RQE implementation on the paper's benchmark environment.
"""
...
# Import TRUE RQE-PPO from sumo baseline directory
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train TRUE RQE-PPO on Cliff Walk environment"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Experiment name (default: TRUE_RQE_PPO_tau{tau}_eps{epsilon})"
    )
...
def main():
    ...
    # Experiment name
    exp_name = args.exp_name or f"TRUE_RQE_PPO_tau{args.tau}_eps{args.epsilon}"

    # Run training
    print("="*70)
    print(f"Starting TRUE RQE-PPO Training on Cliff Walk")
    print("="*70)
